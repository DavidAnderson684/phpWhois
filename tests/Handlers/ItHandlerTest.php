...
use phpWhois\Handlers\ItHandler;
use phpWhois\Whois;
use phpWhois\WhoIsData;


/**
 * CaHandlerTest
 */
class ItHandlerTest extends AbstractHandler
{
    /**
     * @var ItHandler $handler
     */
    protected $handler;
    ...
    protected function setUp(): void
    {
        ...
        $this->handler            = new ItHandler();
        $this->handler->deepWhois = true;
    }
     ...
     * @test
     */
    public function parseItaliaDotIt(): void
    {
        $query = 'italia.it';

        $result = (new Whois())->lookup($query);
